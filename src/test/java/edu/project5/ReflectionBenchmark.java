...
public class ReflectionBenchmark {
    ...
    private Function<Student, String> lambdaGetter;

    @Setup
    public void setup() throws Throwable {
        student = new Student("Ruslan", "Khakimov");
        ...
        lambdaGetter = (Function<Student, String>) callSite.getTarget().invokeExact();
    }
    ...
    @Benchmark
    public void lambdaAccess(Blackhole bh) throws Throwable {
        Object name = lambdaGetter.apply(student);
        bh.consume(name);
    }
}
